...
<footer class="footer">
   ...
   <section class="flex">
      ...
      <div class="box">
         ...
         <a href="mailto:shaikhanas@gmail.com"><i class="fas fa-envelope"></i><span>poojagupta@gmail.com</span></a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>poojagupta</span> | all rights reserved!</div>
